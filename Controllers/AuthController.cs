...
using TheChamber.Models.DTOs;
using TheChamber.Data;

namespace TheChamber.Controllers;
...
{
    private TheChamberDbContext _dbContext;
    private UserManager<IdentityUser> _userManager;

    public AuthController(TheChamberDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
